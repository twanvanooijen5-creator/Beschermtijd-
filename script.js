...
document.getElementById("downloadBtn").addEventListener("click", function () {
    ...
    if (!isMobile) {
        ...
        // Boekenleggerbalk (mobiel dikker)
        const balkBreedte = 160;
        let balkHoogte = window.innerWidth <= 768 ? 35 : 25;
        ...
        // Gecentreerde tekst op boekenlegger
        const tekst = "BESCHERMTIJD!";
        doc.setFontSize(window.innerWidth <= 768 ? 18 : 14);
        doc.setTextColor(255, 255, 255);
        const textWidth = doc.getTextWidth(tekst);
        doc.text(tekst, startX + (balkBreedte - textWidth) / 2, startY + balkHoogte/1.5);
        ...
        doc.text(lines, centerX, startY + balkHoogte + 15, { align: "center" });
